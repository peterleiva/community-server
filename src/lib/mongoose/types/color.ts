...
// type CasterFn = (val: string | number) => number;
...
//     if (
//       isNaN(color) &&
//       isNaN((color = this.transformHexColor(val as string)))
//     ) {
//       throw new TypeError('Value must be a number');
//     }

//     if (color < Color.COLOR_MIN || val > Color.COLOR_MAX) {
//       throw new ColorOutOfRange(val as number, this.path);
//     }
